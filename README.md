...
현재 통계 탭은 재활용 성공 50회를 나무 1그루로 환산한 `나무 살리기` 지표를 표시합니다.

CO₂ 절감량 지표를 함께 사용할 경우 재질별 LCA(전과정평가) 데이터를 기반으로 아래 값을 적용합니다.
>>>>>>> Stashed changes
...
=======
> 절감량은 해당 재질을 재활용했을 때 원자재 생산 대비 회피되는 온실가스량 기준입니다.<br>
>>>>>>> Stashed changes
